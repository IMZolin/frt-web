            ...
            const handleGetImage = async () => {
                try {
                    ...
                    if (response.image_show !== null) {
                        ...
                        setUploading(true);
                        if (addDimensions && response.dimensions) {
                            addDimensions(response.dimensions);
                        }
                        ...
                        state.setBanner({
                            status: 'info',
                            message: `Cache not found (${nameImage}): ${response.message}`
                        });
                    }
                } catch (error) {
            ...
            <DropzoneAreaBase
                ...
                dropzoneText={
                    ...
                    >
                        ...
                        {!uploading && (
                            <>
                                <Typography className="custom-dropzone-text" variant="h3" color="inherit"
                                            textAlign="center">
